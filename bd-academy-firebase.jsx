...
export default function App() {
  ...
  if (view === "quiz") {
    ...
    if (!qs || qs.phase === "finished") {
      const correct = farmerAnswers.filter(fa => { const qq = qs?.questions?.[fa.qIdx]; if (!qq) return false; return Array.isArray(qq.correct) ? qq.correct.includes(fa.answer) : fa.answer === qq.correct; }).length;
